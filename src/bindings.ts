 ...
 */
async agentCreate(fileId: string, payload: AgentCreatePayload) : Promise<Result<AgentCreateResult, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("agent_create", { fileId, payload }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async agentEnable(fileId: string, agentBlockId: string) : Promise<Result<AgentEnableResult, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("agent_enable", { fileId, agentBlockId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async agentDisable(fileId: string, agentBlockId: string) : Promise<Result<AgentDisableResult, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("agent_disable", { fileId, agentBlockId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
